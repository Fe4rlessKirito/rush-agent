...
export function buildSystemPrompt(definitions: ToolDefinition[], projectInstructions?: string): string {
  ...
  return [
    ...
    "Filesystem tools take workspace-relative paths. Use '.' for the active",
    "project root. For an explicit absolute path outside the active workspace,",
    "use a terminal/shell tool instead of list_dir/read_file.",
    "",
    "# Tool selection",
