            ...
            <div className="library-preview" onMouseDown={(e) => e.stopPropagation()}>
              ...
              <div className="library-preview-body">
                ...
                {selectedRun.activity && (
                  <div className={`library-preview-activity ${selectedRun.status}`}>
                    {selectedRun.status === "running" && <span className="research-live-pulse" aria-hidden="true" />}
                    <span>{selectedRun.activity}</span>
                  </div>
                )}
                {selectedRun.searchWarning && <div className="library-preview-warning">{selectedRun.searchWarning}</div>}
                {selectedRun.error && <p className="library-preview-error">{selectedRun.error}</p>}
                ...
                <form className="library-followup-form" onSubmit={(e) => { e.preventDefault(); void continueResearchRun(); }}>
                  <textarea
                    ...
                    placeholder="Continue this research, expand a section, focus it, or ask a follow-up..."
                    disabled={continuing}
                  />
